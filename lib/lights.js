...
function initializeLights() {
  ...
  isLightAOnInput.addEventListener("change", (e) => {
    ...
    document.getElementById("lightDirPhiA").disabled = !isLightAOn;
    document.getElementById("lightDirThetaA").disabled = !isLightAOn;
    document.getElementById("lightColorA").disabled = !isLightAOn;
  });
  ...
  isLightBOnInput.addEventListener("change", (e) => {
    ...
    document.getElementById("lightPosXB").disabled = !isLightBOn;
    document.getElementById("lightPosYB").disabled = !isLightBOn;
    document.getElementById("lightPosZB").disabled = !isLightBOn;
    document.getElementById("lightDecayB").disabled = !isLightBOn;
    document.getElementById("lightColorB").disabled = !isLightBOn;
  });
  ...
  isLightCOnInput.addEventListener("change", (e) => {
    ...
    document.getElementById("lightDirThetaC").disabled = !isLightCOn;
    document.getElementById("lightDirPhiC").disabled = !isLightCOn;
    document.getElementById("lightConeInC").disabled = !isLightCOn;
    document.getElementById("lightConeOutC").disabled = !isLightCOn;
    document.getElementById("lightPosXC").disabled = !isLightCOn;
    document.getElementById("lightPosYC").disabled = !isLightCOn;
    document.getElementById("lightPosZC").disabled = !isLightCOn;
    document.getElementById("lightDecayC").disabled = !isLightCOn;
    document.getElementById("lightColorC").disabled = !isLightCOn;
  });
