...
function main() {
  ...
  var { texture, vao } = loadScenceComponent(baseMesh, "./assets/WoodM1.jpg");
  var { texturePiece, vaoPiece } = loadScenceComponent(pieceMesh, "./assets/WoodL1.png");
  drawScene([baseMesh, pieceMesh], [texture, texturePiece], [vao, vaoPiece]);
  ...
  function loadScenceComponent(mesh, texturePath) {
  ...
  function drawScene(meshes, textures, vaos) {
    animate();
    ...
    window.requestAnimationFrame(() => drawScene(meshes, textures, vaos));
  }
}
